                ...
                <div class="row d-flex justify-content-center" style="overflow: visible;">
                    <div class="col-md-12" style="overflow: visible;">
                                  ...
                                  die("Connection failed: " . $conn->connect_error);
                                   ...
                                   $fetchdata="select p.postlocation,p.postcategory,p.postdescription,p.postimage,u.userimage,p.postcity
                                    from post as p 
                                     ...
                                     u.userid=p.userid and postcategory='hotel' ORDER BY postid DESC limit $offset,$no_of_records_per_page";
                        ...
                        <?php
                         ...
                         $total_pages_sql = "SELECT COUNT(*) FROM post where postcategory = 'hotel'";
                         ...
                         $total_rows = mysqli_fetch_array($result)[0];
                          $total_pages = ceil($total_rows / $no_of_records_per_page);
                               ...
                               echo'<nav class=" pagination d-flex justify-content-center" role="navigation">';
                                  if($pageno>1){
                                    echo"<a href='hotel.php?pageno=".($pageno-1)."'class=' prev page-numbers'>previous</a>";
                                  }

                               for($i=1;$i<=$total_pages;$i++){
                                echo"<a href='hotel.php?pageno=".$i."'class=' page-numbers'>$i</a>";
                               }

                                if($i>$pageno){
                                    echo"<a href='hotel.php?pageno=".($pageno+1)."'class=' next page-numbers'>next</a>";
                                  }
                                  echo'</nav>';
